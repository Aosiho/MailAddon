...
import net.mcreator.mailaddon.gui.PackageGUIGuiWindow;
import net.mcreator.mailaddon.gui.PackageGUIGui;
...
public class PackageItem extends MailAddonModElements.ModElement {
	@ObjectHolder("mail_addon:package")
	public static final Item block = null;

	public PackageItem(MailAddonModElements instance) {
		super(instance, 4);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PackageGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Package");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PackageGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
