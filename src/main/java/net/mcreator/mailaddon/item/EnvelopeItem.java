...
import net.mcreator.mailaddon.gui.EnvelopeGuiGuiWindow;
import net.mcreator.mailaddon.gui.EnvelopeGuiGui;
...
public class EnvelopeItem extends MailAddonModElements.ModElement {
	@ObjectHolder("mail_addon:envelope")
	public static final Item block = null;

	public EnvelopeItem(MailAddonModElements instance) {
		super(instance, 1);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof EnvelopeGuiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MrCrayFishAddonMailItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("envelope");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Envelope");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new EnvelopeGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
